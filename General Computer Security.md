## General Computer and Security Links/Notes

### Computer Forensics, Hacking, Rev Eng, etc.
- [Open Security Training](https://opensecuritytraining.info/Training.html)
- [Access Cyber List of Lists](https://www.accesscyber.org/resources/)
...
- [Online Compiler](https://replit.com/languages/java10)
...
### Bug Bounty
- [HakLuke's List of Lists](https://labs.detectify.com/2021/08/24/hakluke-list-resources-for-beginner-hackers-2021/)
- [Web Security Academy (Port Swigger)](https://portswigger.net/web-security)
-

### Identity Check
- [HPI](https://sec.hpi.de/ilc/)
